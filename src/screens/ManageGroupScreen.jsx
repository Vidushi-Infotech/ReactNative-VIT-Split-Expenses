...
const ManageGroupScreen = ({route, navigation}) => {
  ...
  const handleUploadCoverImage = () => {
    if (!isGroupAdmin) {
      Alert.alert(
        'Error',
        'Only group admins can update the group cover image.',
      );
      return;
    }
  ...
  const uploadCoverImage = async imageUri => {
    ...
    try {
      ...
      const imageUrl = await firebaseService.uploadGroupCoverImage(
        imageUri,
        group.id,
      );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (
        ...
        groupData.coverImage !== group.coverImageUrl
      ) {
          ...
          <TouchableOpacity
            ...
            <View style={styles.groupImageWrapper}>
              {uploadingImage ? (
                ...
                <Image
                  source={{uri: groupData.coverImage}}
