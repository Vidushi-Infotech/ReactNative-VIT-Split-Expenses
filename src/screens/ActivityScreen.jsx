        ...
        try {
          ...
          groupExpenses.forEach(expense => {
            ...
            allActivities.push({
              ...
              type: 'expense_added',
              title: `${isYouPaid ? 'You' : paidByMember?.name || 'Someone'} added "${expense.description}"`,
          ...
          console.error('📱 Error loading expenses for group:', group.id, groupError);
        }
      }
        ...
        try {
          ...
          groupSettlements.forEach(settlement => {
            ...
            if (isYouPaid) {
              ...
              title = `${fromMember?.name || 'Someone'} paid ${toMember?.name || 'Someone'}`;
            }
          ...
          console.log('📱 No settlements or permission issue for group:', group.id);
        }
      }
