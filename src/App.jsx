          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 text-center">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-center gap-3 sm:gap-4 flex-wrap">
                <a href="https://www.instagram.com/kharchasplit/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 transition-all duration-300 group">
                ...
                <a href="https://www.linkedin.com/company/kharchasplit/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors duration-300 group">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
